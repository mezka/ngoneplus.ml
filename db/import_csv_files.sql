...
FROM '/home/mezka/nodejs-oneplus/db/categories.csv' DELIMITER ',' CSV HEADER;
...
FROM '/home/mezka/nodejs-oneplus/db/options.csv' DELIMITER ',' CSV HEADER;
...
FROM '/home/mezka/nodejs-oneplus/db/products.csv' DELIMITER ',' CSV HEADER;
...
FROM '/home/mezka/nodejs-oneplus/db/bundles.csv' DELIMITER ',' CSV HEADER;
